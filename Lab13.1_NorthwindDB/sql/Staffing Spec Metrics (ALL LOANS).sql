...
SELECT 
	...
	, [FHA and FICO<620]	= CASE WHEN LK.FICO < 620 AND PB.ProductBucket LIKE '%FHA%' THEN 'Yes' ELSE 'No' END
...
WHERE LK.Stat21ID BETWEEN 20161000 AND 20170426 --From loans that went Stat 21 for the last 6 months
	AND LK.DeleteFlg = 0
	AND LK.ReverseFlg = 0
